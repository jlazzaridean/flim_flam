...
% F(tau1, tau2, tau3, a1, a2, a3, t) = a1*exp(-t/tau1) + a2*exp(-t/tau2) + a3*exp(-t/tau3);
...
%Made this version 4 on 7/16 to play with the shifting of the IRF. Using
...
x = a1F*exp(-tp/t1F) + a2F*exp(-tp/t2F) + a3F*exp(-tp/t3F);
