...
function [results] = batchFloptimizeExp(decays,IRF,model,cShift,shiftFixed,offFixed,startParam,fixedParam,stFi,period_ns)
...
if(strcmp(model,'1exp'))
    ...
    for i = 1:size(decays,2)
        ...
        [results(i,1).tau, results(i,1).shift, results(i,1).offset,...
            ...
            IRF,cShift,shiftFixed,offFixed,startParam,stFi,period_ns);
    end
...
elseif(strcmp(model,'2exp'))
    ...
    for i = 1:size(decays,2)
        ...
        [results(i,1).tm, results(i,1).a, results(i,1).tau, results(i,1).shift,...
            ...
            shiftFixed,offFixed,startParam,fixedParam,stFi,period_ns);
    end        
...
elseif(strcmp(model,'3exp'))
    ...
    for i = 1:size(decays,2)
        ...
        [results(i,1).tm, results(i,1).a, results(i,1).tau, results(i,1).shift,...
            ...
            IRF,cShift,shiftFixed,offFixed,startParam,fixedParam,stFi,period_ns);
    end    
